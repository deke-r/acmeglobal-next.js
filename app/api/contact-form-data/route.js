    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333;">
          <div style="background-color: #FF432E; color: #fff; padding: 20px; text-align: center;">
            <h2 style="margin: 0;">New Contact Form Submission</h2>
            <p style="margin: 0;">You have a new message from the Acmeglobal website.</p>
          </div>
          ...
          <div style="background-color: #f2f2f2; padding: 10px; text-align: center; font-size: 12px; color: #555;">
            <p style="margin: 0;">This email was sent from the <strong>Acmeglobal website</strong>.</p>
          </div>
        </div>
      `,
    })
